...
2. After signing in, confirm that you can see the project dropdown on the top bar.
   ![Google Cloud Dashboard](public/readme_reference/google/step_1/01-google_cloud_dashboard.png)
...
1. Click the project dropdown on the top bar.
    ![New Project Dialog](public/readme_reference/google/step_2/01-project_dropdown.png)
    *Open project dropdown on top bar.*
2. Select **New Project**.
    ![New Project Dialog](public/readme_reference/google/step_2/02-new_project.png)
    *Create new project.*
3. Enter a project details (e.g., `user-auth-sso`).
   *If there are organization associated to the project, change according to the associated organization folder.*
    ![New Project Dialog](public/readme_reference/google/step_2/03-project_detail_form.png)
    *Create new project.*
4. Click **Create**.
5. Project created
    ![New Project Dialog](public/readme_reference/google/step_2/04-project_created.png)
    *Project created.*
